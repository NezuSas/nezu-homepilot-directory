...
async function enterHomeWithSso(home){ try { const result=await api(/directory/homes//sso-token,{method:'POST'}); enterHome(${home.edgeHostname}/sso/directory?token=); } catch { enterHome(home.edgeHostname); } }
